...
public class Task2{
    ...
    static Worker generateWorker(){
        String[] names = new String[] { "Артем", "Анна", "Кристина", "Вероника", "Николай", "Иван", "Эмиль", "Станислав", "Николай", "Жавохир" };
        String[] surnames = new String[] { "Рахматов", "Кудрявцева", "Камбаров", "Логинова", "Нестеров", "Баженова", "Соловьева", "Танажлов", "Венчук", "Байраковский" };
